...
In order to support loading of multiple wallets in quickcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is quickcoin.cpp.
...
Changes to quickcoin.cpp
----------------------
quickcoin.cpp is the entry point into quickcoin-qt, and as such, will require some minor modifications to provide hooks for
