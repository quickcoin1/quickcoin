...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/quickcoin-cli.cpp \
           src/quickcoin-tx.cpp \
           src/quickcoin.cpp \
           src/db.cpp \
           ...
           src/qt/quickcoin.cpp \
           src/qt/quickcoinstrings.cpp \
...
RESOURCES += src/qt/quickcoin.qrc src/qt/quickcoin_locale.qrc

TRANSLATIONS += src/qt/locale/quickcoin_bg.ts \
                src/qt/locale/quickcoin_de.ts \
                src/qt/locale/quickcoin_en.ts \
                src/qt/locale/quickcoin_es.ts \
                src/qt/locale/quickcoin_fi.ts \
                src/qt/locale/quickcoin_fr.ts \
                src/qt/locale/quickcoin_it.ts \
                src/qt/locale/quickcoin_ja.ts \
                src/qt/locale/quickcoin_pl.ts \
                src/qt/locale/quickcoin_pt.ts \
                src/qt/locale/quickcoin_ru.ts \
                src/qt/locale/quickcoin_sk.ts \
                src/qt/locale/quickcoin_sv.ts \
                src/qt/locale/quickcoin_vi.ts \
                src/qt/locale/quickcoin_zh_CN.ts \
                src/qt/locale/quickcoin_zh_TW.ts
