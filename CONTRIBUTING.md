Contributing to Quickcoin Core
============================

The Quickcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Quickcoin Core project, and is not to be
confused with overall Quickcoin Network Protocol consensus changes.

Whether a pull request is merged into Quickcoin Core rests with the project merge
...
Patches that change Quickcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Quickcoin consensus, it must have been
...
The project leader is the release manager for each Quickcoin Core release.
