...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Quickcoin Core quickcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  quickcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded quickcoin transaction") + "\n" +
                               "  quickcoin-tx [options] -create [commands]   " + _("Create hex-encoded quickcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded quickcoin transaction
