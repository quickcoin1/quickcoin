                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Quickcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Quickcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and quickcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zQIC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Quickcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Quickcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Quickcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Quickcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Quickcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Quickcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Quickcoin Core help message to get a list with possible Quickcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Quickcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Quickcoin network", "", count));
}
...
{
    QString strTitle = tr("Quickcoin Core"); // default title
