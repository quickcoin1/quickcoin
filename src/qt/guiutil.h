...
/** Utility functions used by the Quickcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Quickcoin addresses in monospace font
...
// Parse "quickcoin:" URI into recipient object, return true on successful parsing
