...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Quickcoin Core"),
     ...
     * override -datadir in the quickcoin.conf file in the default data directory
     * (to be consistent with quickcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
