...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Quickcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Quickcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Quickcoin features */
        {"quickcoin", "masternode", &masternode, true, true, false},
        {"quickcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"quickcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"quickcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"quickcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"quickcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"quickcoin", "startmasternode", &startmasternode, true, true, false},
        {"quickcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"quickcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"quickcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"quickcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"quickcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"quickcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"quickcoin", "mnbudget", &mnbudget, true, true, false},
        {"quickcoin", "preparebudget", &preparebudget, true, true, false},
        {"quickcoin", "submitbudget", &submitbudget, true, true, false},
        {"quickcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"quickcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"quickcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"quickcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"quickcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"quickcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"quickcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"quickcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"quickcoin", "mnsync", &mnsync, true, true, false},
        {"quickcoin", "spork", &spork, true, true, false},
        {"quickcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"quickcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use quickcoind, or the -server option to quickcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> quickcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1: 1811/\n";
}
